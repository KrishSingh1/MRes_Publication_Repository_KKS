...
write.csv(combined, paste0('../DATASETS/AusPlots_Extracted_Data/Final/', file_name))

# Plot by Fraction -----------------------------------------------------------

combined <- read.csv('../DATASETS/AusPlots_Extracted_Data/Final/DEA_FC_Ground_Truth_Evaluation_complete_Height_Rule.csv')
