...
site.corners.data <- read.csv('DATASETS/AusPlots_Published_Corner_Points_20240701/Published Plot Corners_extract26062024.csv')
...
clean_set %>%
  sf_to_df(fill = T) %>%
  dplyr::select(c(site_location_name, point, estimation_2, missing, x, y)) %>%
  write.csv('DATASETS/AusPlots_Published_Corner_Points_20240701/Published Plot Corners_extract26062024_cleaned.csv')
